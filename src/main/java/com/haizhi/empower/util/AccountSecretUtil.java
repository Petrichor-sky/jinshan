 ...
 */
public class AccountSecretUtil {
...
//        System.out.println(checkHashPassword("123456", "pbkdf2:sha1:1000$tyQyP5jh$4dfc20ce4392702397fe77b3f9518f8690c3e5e8"));
...
//        System.out.println(BinTools.bin2hex(dk));
        String pwd = genHashPassword("123456");
        System.out.println("pwd=" + pwd);

        boolean b = checkHashPassword("123456", pwd);
        System.out.println("checkHashPassword:" + b);
    }
